<p align="center">
<img src="https://i.imgur.com/CtK5GsY.png" alt="drawing" width="200"/>
</p>
...
* ModMail Ticket Channel **Only** Commands
  * close
    * Close a ticket channel or
    * If You Want To Close The Channel Tikcets Make Sure To Delete The Channel For The Ticket To Be Close.
  * cmds
...
6. Invite your bot using the [Discord Permission Calculator](https://discordapi.com/permissions.html). You need your client ID which is found in your [Developer Portal](https://discord.com/developers/applications)
...
{
    "type": "PLAYING",
    "msg": "DM Me To Contact Staff!"
}
```
This status would display: **Playing DM Me To Contact Staff!**

![Status Example](https://i.imgur.com/RyXYnDg.png)
